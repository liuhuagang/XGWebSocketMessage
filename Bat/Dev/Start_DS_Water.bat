@echo off
rem ============================================
rem [Dev] Local test - Start DS (L_Game_Water :7779)
...
echo [DS] Starting L_Game_Water :7779 ...
XGMultiPlayerServer.exe L_Game_Water -server -log -ManageIP=127.0.0.1 -PublicIP=127.0.0.1 -Port=7779
pause
