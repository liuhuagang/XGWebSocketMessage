@echo off
rem ============================================
rem [Dev] Local test - Start DS (L_Game_Stone :7778)
...
echo [DS] Starting L_Game_Stone :7778 ...
XGMultiPlayerServer.exe L_Game_Stone -server -log -ManageIP=127.0.0.1 -PublicIP=127.0.0.1 -Port=7778
pause
